...
public class GunUpgrade extends Sprite
{
	...
	public void onPlayerCollision(Player player)
	{
		...
		{
			player.weapon =
					new TripleGun(player,(short) (PLAYER_FIRE_RATE*1.5f),(short) (PLAYER_BULLET_SPEED*1.5),projectileTextures[1],(short)50);

		} else if(player.weapon instanceof TripleGun)
		{
			player.weapon =
					new PentaGun(player,(short) (PLAYER_FIRE_RATE),PLAYER_BULLET_SPEED,projectileTextures[2],(short)250);
		}
